const Skills = () => {
  return (
    ...
    >
      ...
      <div className="absolute w-64 h-64 bg-blue-500/20 rounded-full blur-3xl top-12 left-16"></div>
      <div className="absolute w-72 h-72 bg-purple-500/20 rounded-full blur-3xl bottom-16 right-12"></div>
      ...
      <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl w-full">
        ...
        {/* Frontend Card */}
        <div className="p-6 bg-[#1e293b] rounded-xl shadow-lg hover:shadow-xl transition hover:-translate-y-1 border border-gray-700">
        ...
        {/* Database Card */}
        <div className="p-6 bg-[#1e293b] rounded-xl shadow-lg hover:shadow-xl transition hover:-translate-y-1 border border-gray-700">
          <h3 className="text-xl font-semibold text-blue-400 mb-4">Database & Storage</h3>
          <ul className="space-y-2 text-gray-300">
            <li>MongoDB</li>
            <li>Mongoose ODM</li>
            <li>Atlas Cloud</li>
        ...
        {/* Tools Card */}
        <div className="p-6 bg-[#1e293b] rounded-xl shadow-lg hover:shadow-xl transition hover:-translate-y-1 border border-gray-700">
          <h3 className="text-xl font-semibold text-blue-400 mb-4">Tools & Platforms</h3>
          <ul className="space-y-2 text-gray-300">
            <li>Git & GitHub</li>
            <li>Postman</li>
            <li>VS Code</li>
